...
| `KILN_AGENT_GUIDE_URL`                | —                        | URL surfaced in the colophon as "Agents → /v1/agent/context-pack" so a visiting engineer discovers the agent surface (#314). Typically the published `docs/agent-integration-guide.md` URL on your fork's GitHub. Default-unset means no link rendered. |
